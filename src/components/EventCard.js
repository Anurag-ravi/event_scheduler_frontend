...
const EventCard = () => {
    return (
        <div className='flex flex-row shadow-md rounded-2xl' style={ {width:734} }>
            <div className='w-1/2 rounded-tl-2xl rounded-bl-2xl' style={ {height:240} }>
                <img src={event} alt="" className='rounded-tl-2xl rounded-bl-2xl h-60' style={ {width:367} }/>
            ...
            <div className='w-1/2 flex flex-col p-4' style={ {height:240} }>
                ...
                <div className='text-white w-14 h-8 text-sm rounded-lg text-center pt-1.5 self-end cursor-pointer hover:scale-105 duration-300 font-medium' style={{backgroundColor:'#6FCF97'}}>
                        Pay
                    </div>
            </div>
        </div>
